...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀 𝗔𝗟𝗠𝙊𝗟𝙐𝗞◍━━━━⩺ ⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀 𝗔𝗟𝗠𝙊𝗟𝙐𝗞◍━━━━⩺"
...
io.popen("cd File_Bot && wget https://raw.github.com/frawnwa13/offlinfrawn/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,2026498957,1933161559,1970574026,1885706669,2021791139,1967887608,1952686240}   
...
var = true
elseif tonumber(user_id) == tonumber(2021791139) then
var = true  
...
if text == 'رفع ملف فرعون' and Debn(msg) then 
...
send(msg.chat_id_, msg.id_,' ◍ اصدار سورس فرعون{ S:17✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/source_almoluk"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == "توكن زب فرعون" and SudoBot(msg) or text == 'جلب زب فرعون' and SudoBot(msg) then 
if not Debn(msg) then
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
「المبرمج فرعون الكبير لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓」
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𖤍 𝗗𝙀𝗩 𝗙𝙍𝗔𝙒𝗡𖤍', url="t.me/DEV_FRAWN"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗦𝙊𝙐𝙍𝗖𝙀 𝗔𝗟𝗠𝙊𝗟𝙐𝗞', url="t.me/source_frawn"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text=="لب سوبر " and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ◍ ارسل الان اذاعتك؟ \n ◍ للخروج ارسل الغاء ")
return false
end  
if text=="لب سوبر بالتوجيه " and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ◍ ارسل لي التوجيه الان")
return false
end 
if text=="لب سوبر بالتوجيه خاص " and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/source_frawn/359&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/source_frawn/353&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text ==  'زغلل'   then
local Text = [[
االمبرمج زغلل لؤ عٲيز تتؤٲصل معٲه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text ==  'جبريه'  then
local Text = [[
مع مبرمج السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text =  '𝗗𝙀𝗩 𝙂𝘼𝘽𝙀𝙍',url="t.me/G_A_B_E_3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token.. '/sendPhoto?chat_id='  .. msg.chat_id_ ..  '&photo=https://t.me/G_A_B_E_3&caption='  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text ==  'بندوق'  then
local Text = [[
...
if text=="لب سوبر بالتثبيت" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
...
" ينفع نرتبط؟", 
" ايه رايك في  سما القدره",
"ايه رايك في جوري الشرموطه ",
" ايه رايك في فرعون جدع وله لا",
...
if text == 'رفع نسخه' and Debn(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تطير عام") and msg.reply_to_message_id_ and SudoBot(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع تطير  المبرمج فرعون الكبير  عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع تطير مبرمج جميع السورسات  عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(2021791139) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(2011563821) then  
...
if text and text:match("^تطير عام @(.*)$")  and SudoBot(msg) then
local username = text:match("^تطير عام @(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local Groups = database:scard(bot_id..'Chek:Groups')  
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if result.id_ == tonumber(2021791139) then
...
if text and text:match("^تطير عام (%d+)$") and SudoBot(msg) then
local userid = text:match("^تطير عام (%d+)$")
if AddChannel(msg.sender_user_id_) == false then
local Groups = database:scard(bot_id..'Chek:Groups')  
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if tonumber(userid) == tonumber(2021791139) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس  عام")
return false 
end
...
if result.id_ == tonumber(2026498957) then
send(msg.chat_id_, msg.id_, " ◍ لا يمكنك كتم مبرمج جميع السورسات  \n")
return false 
end
if result.id_ == tonumber(1885706669) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر المبرمج زغلل \n")
...
if text == ("فك حظر") and msg.reply_to_message_id_ and SudoBot(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^فك حظر @(.*)$") and SudoBot(msg) then
local username = text:match("^فك حظر  @(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^فك حظر  (%d+)$") and SudoBot(msg) then
local userid = text:match("^فك حظر  (%d+)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if Debn(msg) then
local Get_Files, res = https.request("https://raw.github.com/frawnwa13/offlinfrawn/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.github.com/frawnwa13/offlinfrawn/main/File_Bot/"..file)
if res == 200 then
...
if text == ("تنزيل مرات اوفلاين") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مرات اوفلاين@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل مرات اوفلاين@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مرات اوفلاين(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل مرات اوفلاين(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Reply_Status(msg,result.sender_user_id_,"reply","[◍ تم ترقيته مطور اساسي² في البوت](https://t.me/source_frawn)")  
end
...
Reply_Status(msg,userid,"reply","[◍ تم ترقيته مطور اساسي² في البوت](https://t.me/source_frawn)")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","[◍ تم تنزيله من المطور اساسي²](https://t.me/source_frawn)")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BANDA, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","[◍ تم تنزيله من المطور اساسي²](https://t.me/source_frawn)")  
else
send(msg.chat_id_, msg.id_,"◍ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","[◍ تم تنزيله من المطور اساسي²](https://t.me/source_frawn)")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀 𝗔𝗟𝗠𝙊𝗟𝙐𝗞◍━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━◍𝗦𝙊𝙐𝙍𝗖𝙀 𝗔𝗟𝗠𝙊𝗟𝙐𝗞◍━━━━⩺ٴ\n ◍ ◍ ')
end
...
if text == 'تفعيل لب سوبر' and SudoBot(msg) then  
...
if text == 'تعطيل لب سوبر' and SudoBot(msg) then  
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فرعون').." اوفلاين غادر" or text == 'فرعون غادر' then  
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[اسال البشمبرمج فرعون الكبير](t.me/DEV_FRAWN)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[عمل واحد من شويه مع امك 😹😹](https://t.me/source_frawn)') 
return false
end

if text == 'باي' or text == 'بيي' then
send(msg.chat_id_,msg.id_, '[شد الباب ورك هتقرفنه 🙄](https://t.me/source_frawn)') 
return false
end

if text == 'طيب' or text == 'تيب' then
send(msg.chat_id_,msg.id_, '[تطيب روحك .. ي عيوني 🌸🤍](https://t.me/source_frawn)') 
return false
end

if text == 'شكرا' or text == 'ميرسي' then
send(msg.chat_id_,msg.id_, '[◍ العفو ياروحي..🌚💘](https://t.me/source_frawn)') 
return false
end

if text == 'هلو' or text == 'هلا' then
send(msg.chat_id_,msg.id_, '[◍ هلا بيك ياروحي..💛](https://t.me/source_frawn)') 
return false
end

if text == 'تمم' or text == 'تمام' then
send(msg.chat_id_,msg.id_, '[◍ دايما ياحبيبي..🌚💜](https://t.me/source_frawn)') 
return false
end

if text == 'حصل' or text == 'حصل😂' then
send(msg.chat_id_,msg.id_, '[حصل في الحمام وانا شهد](https://t.me/source_frawn)') 
return false
end
...
if text == 'نصيح '  or text == 'النصيح ' then
send(msg.chat_id_,msg.id_, ' [نصيح مني ليك متنكش في فرعون لانو لو حطك في دمغو هينيككك فل ](https://t.me/DEV_FRAWN)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[◍ سقف الجروب عاجبك..😂💜](https://t.me/source_frawn)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_,'[تم فتح الحك يله حكو بقه صحاب الجروب قلبه كبريه](https://t.me/source_frawn)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ده انته الي بوت ي كسمك](https://t.me/source_frawn)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, ' [نعم ي كتفمك ارغي مش فضيلك 🙄💜](https://t.me/source_frawn)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, ' [ابوي نط علي المتنك امك ](https://t.me/source_frawn) ') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[امك مره دعكه](https://t.me/source_frawn)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, ' [داد فرعون فين في حد بيسال عليك](https://t.me/DEV_FRAWN)' ) 
return false
end
end
end
